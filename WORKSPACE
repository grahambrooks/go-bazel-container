...
http_archive(
    ...
    urls = [
        ...
        "https://github.com/bazelbuild/rules_go/releases/download/v0.63.0/rules_go-v0.22.2.tar.gz",
    ],
...
http_archive(
    name = "bazel_gazelle",
    urls = [
        "https://storage.googleapis.com/bazel-mirror/github.com/bazelbuild/bazel-gazelle/releases/download/v0.53.0/bazel-gazelle-v0.53.0.tar.gz",
